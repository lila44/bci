...
//		
//		String text = "임정채";
//		String key = "A93KDKDMNE04L1L4";
//
//		
//		
//		String encryptText = Base64.encode(new Seed().encrypt(text, key.getBytes(), "UTF-8"));
//		String decryptText = new Seed().decryptAsString(Base64.decode(encryptText), key.getBytes(), "UTF-8");
//		
//		
//
//		System.out.println("데이터:" + text);
